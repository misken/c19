...
BH_market_share = (
    st.sidebar.number_input(
        "Hospital Market Share (%)", 0.0, 100.0, value=market_share, step=1.0, format="%f"
    )
    / 100.0
)
...
- The total size of the susceptible population will be the entire catchment area for BH entities (RO, TR, DB, TN, GP)
  - Wayne = {wayne}
  - Oakland = {oakland}
  - Macomb = {macomb}
  - Genesee = {genesee}
...
st.markdown("Projected number of **daily** COVID-19 admissions at BH hospitals")
