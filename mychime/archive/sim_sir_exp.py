...
SEMich_market_share = market_share / 100
...
total_infections = current_hosp / SEMich_market_share / hosp_rate
...
hosp = i * hosp_rate * SEMich_market_share
icu = i * icu_rate * SEMich_market_share
vent = i * vent_rate * SEMich_market_share
